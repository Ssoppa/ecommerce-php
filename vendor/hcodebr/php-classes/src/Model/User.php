    ...
    public static function getForgot($email, $inadmin = true) {
		...
		if (count($results) === 0)
		{
            ...
            if(count($results2) === 0) {
                ...
                if ($inadmin === true) {
                    $link = "http://www.supperecommerce.com.br:8080/admin/forgot/reset?code=$result";
                } 
                else {
                    $link = "http://www.supperecommerce.com.br:8080/forgot/reset?code=$result";
                } 
                $mailer = new Mailer($data['desemail'], $data['desperson'], "Redefinir senha da Supper Store", "forgot", array(
                    "name"=>$data['desperson'],
                    "link"=>$link
                )); 
